<?php
    ...
    if(!$name || !$postcode || !$address || !$detailAddress || !$phoneNum){
        ...
        if($isDefault){
           $sql = "UPDATE desInfo SET name='$name', postcode='$postcode', address='$address', detailAddr='$detail', phoneNum='$phoneNum',  defaultDes=1 WHERE NUM='$num';";
        }
        else{
            $sql = "UPDATE desInfo SET name='$name', postcode='$postcode', address='$address', detailAddr='$detail', phoneNum='$phoneNum',  defaultDes=0 WHERE NUM='$num';";
        }
